module.exports = {
    ...
    async execute(message, args) {
        ...
        const unicode = /\p{Extended_Pictographic}/u.test(args[2]);
        if (unicode) {
            ...
            if (msg) {
                msg.roles.push({roleID: roleID, emojiID: args[2]});
            } else {
                messages.push({messageID: messageID, roles: [{roleID: roleID, emojiID: args[2]}]});
            }
